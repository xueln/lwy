...
#插入商品表信息
INSERT INTO lwy_product 
(pid, family_id, title, subtitle, price, saleNum, spec, details, shelf_time) 
VALUES (1, 10, 'BeeFo小唱机', '前卫唱机设计，小巧优雅，方正的调性，尽显品味；小体积也有好音乐，内置双3W全频喇叭，爆发每个音符的能量，全方位诠释立体音，实力演绎千百种曲风，尽享HiFi音质。多种功能于一身小唱机，唱响你的生活~', 399, 0, '直接购买', NULL, NULL), 
(4, 10, 'BeeFo小唱机', '前卫唱机设计，小巧优雅，方正的调性，尽显品味；小体积也有好音乐，内置双3W全频喇叭，爆发每个音符的能量，全方位诠释立体音，实力演绎千百种曲风，尽享HiFi音质。多种功能于一身小唱机，唱响你的生活~', 409, 0, '个性定制', NULL, NULL);
...
#插入信息
INSERT INTO lwy_pro_pic 
(pid, lid, color, is_spot, sm, md, lg) 
VALUES (NULL, '1', '栗米灰', 1, 'img/detail/sm1.jpg', 'img/detail/md1.jpg', 'img/detail/lg1.jpg'), 
...
(NULL, 4, '奶酪白', 1, 'img/detail/sm_diy1.jpg', 'img/detail/md_diy.jpg', 'img/detail/lg_diy1.jpg'), 
...
#插入轮播图图片
INSERT INTO lwy_index_carousel (cid, img, pro_id) 
VALUES (NULL, 'img/index/carousel/carousel1.jpg', 1), 
